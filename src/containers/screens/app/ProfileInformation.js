...
const ProfileInformation = props => {
  ...
  const documentPic = async () => {
    try {
      ...
      updateProfileImage1(newImage2, Math.round(newlet), res.name);
  ...
  const handleImgRes1 = async res => {
    if (typeof res != 'string') {
      ...
      setLoadingLegal(true);
      setLoadingTextLegal(false);
      updateProfileImage1(newImage2, Math.round(newlet), name);
      if (workingStatusExpire == true) {
        if (state.expiredob == '') {
          setDeActive(false);
        } else {
  ...
  const editProfile = () => {
    ...
    body.append('phone_number', state.mobile1);
  ...
  const updateProfileImage1 = (val, newlet, name) => {
    let Body = new FormData();
  ...
  const ValidateSinNumber = () => {
    ...
    body.append(
      'sin_number',
      sinchangevalue == true ? state.sin : state.sinwithoutstar,
    );
          ...
          <Modal
            ...
            <View style={{flex: 1}}>
              <View
                ...
                {console.log(
                  ' state.expiredob state.expiredob',
                  state.expiredob,
                )}
                {console.log(
                  ' state.expiredob state.expiredob',
                ...
                <DatePicker
                  ...
                  confirm={selectedDate => {
                    ...
                    setState({
                      ...state,
                      expiredob: moment(state.ExpirecalenderDate).format(
                        'YYYY-MM-DD',
                      ),
                    });
                  }}
                  ...
                  onValueChange={selectedDate => {
                    setState({
                      ...state,
                      ExpirecalenderDate: selectedDate,
                    });
                  }}
                />
              </View>
              ...
              <DatePicker
                ...
                confirm={selectedDate => {
                  ...
                  if (agevalue < 18) {
                    ...
                    if (state.calenderDate == state.dobold) {
                      setState({
                        ...state,
                      ...
                      setState({
                        ...state,
                        dob: moment(state.calenderDate).format('YYYY-MM-DD'),
                      });
                    }
                  }
                }}
